...
export const en = {
  ...
  "auth.passkeyNeedsDomain": "A passkey is tied to a host name, so it cannot be used on a bare IP address.",
...
export const de: Translations = {
  ...
  "auth.passkeyNeedsDomain": "Ein Passkey hängt an einem Rechnernamen und funktioniert deshalb nicht auf einer nackten IP-Adresse.",
