...
export const en = {
  ...
  // (GlimStone follow-up round); removing the text label loses the
  ...
  // The reset is now the named exit to auto-detection, so
  ...
  // (D-05, INTEG-04): the reset control and its fail-tone
  ...
  // (D-02, SELECT-03): the narrowing note; event-driven
  ...
  // (D-06, RESTIC-01): the per-root CACHEDIR.TAG
  ...
  // Card it titled was split into one Card per sub-topic (a live review
  // decision), and nothing else ever read this key.)
  //   "settings.colors" is a later live review's own new key (jdp:
  ...
  // New in the GlimStone follow-up pass, live review (presets became
  ...
  // Row label in front of the 8 swatches (live review); a
  ...
  // Config self-backup (BombVault's own settings). Minimal en/de set to start;
  // the full 24-locale translation followed.
  ...
  // flash domain for this). The platform-expansion work.
  ...
  // Files domain integration; Settings, Dashboard, Recovery
  ...
  // Dashboard activity log; a flat, docker-logs-style merged view of
...
export const de: Translations = {
  ...
  // zum Start; die vollständige 24-Sprachen-Übersetzung folgte.
