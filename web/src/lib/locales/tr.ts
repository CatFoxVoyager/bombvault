...
const tr: Partial<Translations> = {
  ...
  "settings.platformHint": "Uygulamanın mobil arayüz biçimi: Material Android kurallarını, Cupertino iOS kurallarını izler.",
  ...
  "files.emptyRule": "Bir set en az bir klasör gerektirir. Son işaret kaldırılamaz. Tamamen kaldırmak için {action} kullanın.",
