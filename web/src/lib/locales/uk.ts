...
const uk: Partial<Translations> = {
  ...
  "settings.platformHint": "Вигляд мобільного інтерфейсу застосунку: Material дотримується звичаїв Android, Cupertino дотримується звичаїв iOS.",
  ...
  "files.emptyRule": "Для набору потрібна принаймні одна папка. Останню позначку не можна зняти. Використовуйте {action}, щоб видалити його повністю.",
