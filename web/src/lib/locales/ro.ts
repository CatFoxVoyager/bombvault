...
const ro: Partial<Translations> = {
  ...
  "settings.platformHint": "Forma interfeței mobile ale aplicației: Material urmează convențiile Android, Cupertino pe cele ale iOS.",
  ...
  "files.emptyRule": "Un set are nevoie de cel puțin un dosar. Ultima bifare nu poate fi scoasă. Folosiți {action} pentru a-l elimina complet.",
