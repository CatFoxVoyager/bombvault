...
const pl: Partial<Translations> = {
  ...
  "settings.platformHint": "Wygląd mobilnego interfejsu aplikacji: Material stosuje konwencje Androida, Cupertino konwencje iOS.",
  ...
  "files.emptyRule": "Zestaw potrzebuje co najmniej jednego folderu. Ostatniego zaznaczenia nie można usunąć. Użyj {action}, aby usunąć go całkowicie.",
