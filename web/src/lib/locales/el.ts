...
const el: Partial<Translations> = {
  ...
  "auth.passkeyNeedsDomain": "Ένα κλειδί πρόσβασης δένεται με όνομα κόμβου, οπότε δεν λειτουργεί σε σκέτη διεύθυνση IP.",
  ...
  "auth.passkeyAdd": "Προσθήκη κλειδιού πρόσβασης",
