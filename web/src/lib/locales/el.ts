...
const el: Partial<Translations> = {
  ...
  "settings.platformHint": "Η μορφή της κινητής διεπαφής της εφαρμογής: Material ακολουθεί τις συμβάσεις του Android, Cupertino αυτές του iOS.",
  ...
  "files.emptyRule": "Ένα σετ χρειάζεται τουλάχιστον έναν φάκελο. Το τελευταίο τικ δεν μπορεί να αφαιρεθεί. Χρησιμοποιήστε το {action} για να το αφαιρέσετε εντελώς.",
