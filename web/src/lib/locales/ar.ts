...
const ar: Partial<Translations> = {
  ...
  "settings.appearance": "المظهر العام",
  ...
  "settings.platformHint": "شكل واجهة التطبيق للجوال: Material يتبع أعراف أندرويد، وCupertino يتبع أعراف iOS.",
  ...
  "files.emptyRule": "يحتاج المجموعة إلى مجلد واحد على الأقل. لا يمكن إزالة آخر علامة. استخدم {action} لإزالتها بالكامل.",
