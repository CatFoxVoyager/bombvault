...
const hu: Partial<Translations> = {
  ...
  "settings.platformHint": "Az alkalmazás mobil felületének formája: Material az Android konvencióit követi, Cupertino az iOS-ét.",
  ...
  "files.emptyRule": "A készletnek legalább egy mappára van szüksége. Az utolsó jelölés nem távolítható el. A {action} használatával távolítsa el teljesen.",
