...
const he: Partial<Translations> = {
  ...
  "settings.platformHint": "צורת הממשק הנייד של האפליקציה: Material עוקב אחר המוסכמות של Android, וגם Cupertino אחר אלה של iOS.",
  ...
  "files.emptyRule": "סט צריך לפחות תיקייה אחת. לא ניתן להסיר את הסימון האחרון. השתמשו ב־{action} כדי להסיר אותו לחלוטין.",
