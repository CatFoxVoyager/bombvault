...
const no: Partial<Translations> = {
  ...
  "settings.platformHint": "Appens mobile grensesnittform: Material følger Androids konvensjoner, Cupertino følger iOS.",
  ...
  "files.emptyRule": "Et sett trenger minst én mappe. Det siste haket kan ikke fjernes. Bruk {action} for å fjerne det helt.",
  ...
  "recovery.mobile.stepOf": "Trinn {n} av {total}",
