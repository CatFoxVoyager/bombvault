...
const pt: Partial<Translations> = {
  ...
  "settings.platformHint": "A forma da interface móvel da aplicação: Material segue as convenções do Android, Cupertino as do iOS.",
  ...
  "files.emptyRule": "Um conjunto precisa de pelo menos uma pasta. A última marcação não pode ser removida. Use {action} para removê-lo por completo.",
  ...
  "recovery.mobile.stepOf": "Passo {n} de {total}",
