...
const fr: Partial<Translations> = {
  ...
  "auth.passkeyNeedsDomain": "Une clé d'accès est liée à un nom d'hôte et ne peut donc pas servir sur une simple adresse IP.",
  ...
  "auth.passkeyAdd": "Ajouter une clé d'accès",
