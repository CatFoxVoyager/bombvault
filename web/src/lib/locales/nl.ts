...
const nl: Partial<Translations> = {
  ...
  "settings.platformHint": "De vorm van de mobiele interface van de app: Material volgt de conventies van Android, Cupertino die van iOS.",
  ...
  "files.emptyRule": "Een set heeft minimaal één map nodig. Het laatste vinkje kan niet worden verwijderd. Gebruik {action} om de set volledig te verwijderen.",
