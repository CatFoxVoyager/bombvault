...
const es: Partial<Translations> = {
  ...
  "auth.passkeyNeedsDomain": "Una clave de acceso está ligada a un nombre de host, así que no sirve en una dirección IP a secas.",
  ...
  "auth.passkeyAdd": "Añadir una clave de acceso",
