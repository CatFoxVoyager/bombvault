...
const th: Partial<Translations> = {
  ...
  "settings.platformHint": "รูปลักษณ์อินเทอร์เฟซมือถือของแอป: Material เป็นไปตามรูปแบบของ Android ส่วน Cupertino เป็นไปตามรูปแบบของ iOS",
  ...
  "files.emptyRule": "ชุดต้องมีโฟลเดอร์อย่างน้อยหนึ่งโฟลเดอร์ ไม่สามารถยกเลิกการเลือกรายการสุดท้ายได้ ใช้ {action} เพื่อลบชุดนี้ทั้งหมด",
