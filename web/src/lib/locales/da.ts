...
const da: Partial<Translations> = {
  ...
  "settings.platformHint": "Appens mobile grænseflades udformning: Material følger Androids konventioner, Cupertino følger iOS's.",
  ...
  "files.emptyRule": "Et sæt kræver mindst én mappe. Det sidste hak kan ikke fjernes. Brug {action} til at fjerne det helt.",
