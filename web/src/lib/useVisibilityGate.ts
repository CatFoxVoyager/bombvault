// ---------------------------------------------------------------------------
// USE VISIBILITY GATE — the ONE Page-Visibility hook (PRIM-04 / D-10), plus
// the plain read non-React consumers use.
//
// PRIM-04's contract is that SSE consumers and poll timers PAUSE while the
// page is hidden and reconcile from SERVER state when it returns. D-10 fixes
...
// document-less context; this default degrades to exactly the pre-PRIM-04
...
/** True while the page is visible (PRIM-04's pause gate). Windowless/server
