...
// ---------------------------------------------------------------------------
// useLoadMore — window math and behavior proofs for LISTS-01 / D-11 (phase 7
// plan 02). loadMoreWindow is pure, so its boundary math is asserted directly;
...
describe("useLoadMore (hook)", () => {
  ...
  it("keeps the constant threshold across the hook's life (D-11)", () => {
    const items = makeItems(45);
