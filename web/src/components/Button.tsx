...
// Mobile hit-area extension (D-06 fix 1 / VERIFY-04, phase 8): glim-btn's
...
// 32px control); class-for-class the pattern Toggle.tsx documented in phase
// 7, now lifted into this shared control because the Settings stacked cards
// ARE the desktop panels (07-05's shared-panels decision), so every Button
