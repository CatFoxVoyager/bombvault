...
// Behavioral proof for PRIM-03 / D-07: ONE useConfirm promise API, TWO
// presentation halves. The sheet half (ConfirmSheet) is asserted directly as
// observable behavior — stacked action order, tone mapping, close paths,
// focus discipline — and the swap itself is asserted through the real
...
describe("ConfirmSheet (the mobile presentation, direct)", () => {
  ...
  it("renders the fail-toned sheet with the destructive confirm stacked ABOVE the safe cancel", () => {
    ...
    // BottomSheet's tone surface: the PRIM-03 fail-tone panel.
  ...
  it("starts focus on the sheet's close control, never on the destructive one", () => {
    ...
    // outcome. D-07: no autoFocus anywhere in this tree can steal it.
...
describe("useConfirm presentation swap (D-07)", () => {
  beforeEach(() => {
    desktopMatches = true;
    vi.stubGlobal("matchMedia", fakeMql);
  });
