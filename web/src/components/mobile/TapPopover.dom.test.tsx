...
// Behavioral proof for PRIM-02 (D-09): tap-open, three dismissal paths
...
describe("TapPopover (PRIM-02)", () => {
  ...
  it("dismisses on an outside tap that lands on the transparent consuming backdrop — never on the content beneath", () => {
    ...
    // The layer is a real full-viewport fixed element (T-06-03: a real
