...
/**
 * MoreSheet's dom contract (SHELL-03, phase 05 plan 05 Task 2).
 *
 ...
 *     hand-written list (the drift SHELL-03 exists to kill), and bar
 ...
 *     reload, with NO confirmation dialog anywhere in the flow (the locked
 *     decision from 05-CONTEXT.md).
 *
...
describe("MoreSheet rows are the ONE registry", () => {
  ...
  it("hides gated tabs like the desktop Sidebar and never shows bar destinations", () => {
    ...
    // duplicate-destination drift SHELL-03 forbids.
