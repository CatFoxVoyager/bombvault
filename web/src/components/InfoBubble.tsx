...
//
// Tap path (phase 6, PRIM-02): hover and focus are both dead on a phone, so
// below the coarse-pointer axis — capability, NOT width, per D-11's axis
// separation; useTipBubble's documented manual show()/hide() API is the
  ...
  return (
    <>
      {/* bv-convention-exception: one-icon-badge-size -- the 44px box below is
          the mandated touch tap target (UI-SPEC exceptions table; same
