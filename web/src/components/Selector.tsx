...
export const HUE_OFFSET = {
  ...
  theme: 6,
  notifyOn: 7,
  /** The Platform sub-section's material/cupertino picker (PLAT-01, our
   *  D-11 device pass). 8 is the next free start after theme (6) and
   *  notifyOn (7) — the picker first shipped with the literal 6, which
   *  collided with theme's once the shared table arrived. */
  platform: 8,
  drillKind: 1,
} as const;
