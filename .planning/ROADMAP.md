...
- [ ] **Phase 5: Mobile Shell & Navigation Foundation** - One quarantined breakpoint decision swaps the Sidebar for the bottom bar + More sheet with safe-area, viewport-height, and keyboard correctness; desktop renders unchanged; the Playwright harness gates responsive regressions from day one
...
| 5. Mobile Shell & Navigation Foundation | v1.1 | 1/6 | In Progress|  |
