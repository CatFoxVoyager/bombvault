...
| 08-01-03 | 01 | 1 | SCRN-06, VERIFY-03 | — | API parity call multiset (21 calls), full-object PUT, kit filename, desktop leakage needles | e2e | `npx playwright test e2e/guided-restore.spec.ts e2e/desktop-untouched.spec.ts` | ✅ both specs | ✅ green (6a9cf933; full tail gate in flight) |
